...
const EmptyCart = () => {
  ...
  return (
    <div className="flex flex-col items-center rounded-brutal-lg border-2 border-dashed border-ink/30 bg-white px-4 py-12 text-center shadow-brutal-sm">
      <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-brutal border-2 border-ink bg-sunny-yellow text-green-600 shadow-brutal-sm">
      ...
      <h3 className="mb-2 text-base font-extrabold text-ink">Your cart is empty</h3>
      <p className="mb-6 max-w-xs text-sm font-medium text-dark-4">
        Looks like you have not added anything yet. Start shopping to fill your
        cart.
      </p>
      <Link
        onClick={() => closeCartModal()}
        href="/shop"
        className="inline-flex w-full max-w-xs items-center justify-center rounded-brutal border-2 border-ink bg-green-600 px-6 py-3 text-sm font-extrabold text-white shadow-brutal transition-all duration-150 hover:translate-x-0.5 hover:translate-y-0.5 hover:bg-green-700 hover:shadow-none"
      >
        Continue Shopping
      </Link>
    </div>
