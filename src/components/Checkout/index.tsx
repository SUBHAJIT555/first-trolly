        ...
        <section className="bg-cream py-16 sm:py-20 lg:py-24">
          <div className="mx-auto max-w-lg px-4 text-center sm:px-6">
            <div className="rounded-brutal-lg border-2 border-dashed border-ink/30 bg-white px-6 py-12 shadow-brutal-sm">
              <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-brutal border-2 border-ink bg-sunny-yellow text-green-600 shadow-brutal-sm">
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:gap-10">
                <div className="space-y-6 lg:col-span-8">
                  ...
                  <div className="overflow-hidden rounded-brutal-lg border-2 border-ink bg-white shadow-brutal-sm">
                    <div className="border-b-2 border-ink bg-cream px-5 py-4 sm:px-6">
                      <label htmlFor="notes" className="font-extrabold text-ink">
                    ...
                    <div className="p-5 sm:p-6">
                      <textarea
                        ...
                        className="w-full resize-none rounded-brutal border-2 border-ink bg-white p-4 text-sm font-medium text-ink outline-none placeholder:text-dark-5 focus:translate-x-0.5 focus:translate-y-0.5"
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="lg:sticky lg:top-28">
                    <div className="overflow-hidden rounded-brutal-lg border-2 border-ink bg-white shadow-brutal">
                      <div className="border-b-2 border-ink bg-sunny-yellow px-5 py-4 sm:px-6">
                        ...
                        <h3 className="mt-1 text-lg font-extrabold text-ink">Your Order</h3>
                        <p className="mt-1 text-sm font-medium text-dark-4">
                          {cartItems.length}{" "}
                    ...
                    {error && (
                      <p
                        className="mt-4 rounded-brutal border-2 border-red-dark bg-red-light-4 px-4 py-3 text-sm font-medium text-red-dark"
                        role="alert"
                      >
                        {error}
                      </p>
