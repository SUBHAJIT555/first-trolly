...
const qtyBtnClass =
  "flex h-10 w-10 items-center justify-center font-bold text-ink transition-all duration-150 hover:bg-cream disabled:cursor-not-allowed disabled:opacity-40";
...
const SingleItem = ({ item }: { item: CartItem }) => {
  ...
  const lineSubtotal = item.discountedPrice * quantity;
  const lineMrp = item.price * quantity;
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 flex flex-col gap-4 border-t-2 border-ink/10 pt-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <div className="inline-flex items-center overflow-hidden rounded-brutal border-2 border-ink bg-white shadow-brutal-sm">
                <button
                  type="button"
                ...
                <span className="flex h-10 min-w-[2.75rem] items-center justify-center border-x-2 border-ink bg-sunny-yellow px-2 text-sm font-extrabold text-ink">
                  {quantity}
                </span>
                <button
                  type="button"
            ...
            <div className="sm:text-right">
              ...
              {hasDiscount && (
                <p className="text-xs font-medium text-dark-4 line-through">
